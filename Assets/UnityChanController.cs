...
public class UnityChanController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Unityちゃんを矢印キーまたはボタンに応じて左右に移動させる（追加２）(追加９）
        ...
        //ジャンプしていない時にスペースが押されたらジャンプする（追加３）
        ...
        //Unityちゃんに速度を与える（追加1→追加２で変更→追加３で変更）
